...
import services.ScientificAreaService;
...
public class AreaController {
	...
	public ResponseEntity<List<ScientificAreaDto>> get(){
		...
		List<ScientificAreaDto> scientificAreasDTO = new ArrayList<>();
		
		for(ScientificArea c : scientificAreas){
